...
namespace BankingEcosystem.Backend.Migrations
{
    ...
    [Migration("20260304065548_AddMbankingFavoritesBank")]
    partial class AddMbankingFavoritesBank
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingEcosystem.Backend.Models.Bank", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            BankId = 15,
                            BankCode = "ECOSYS",
                            BankName = "Banking Ecosystem (Internal)"
                        });
                });
            ...
            modelBuilder.Entity("BankingEcosystem.Backend.Models.FavoriteTransfer", b =>
                {
                    ...
                    b.Property<string>("FavoriteAccountNumber")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("FavoriteTransfers");
                });

            modelBuilder.Entity("BankingEcosystem.Backend.Models.MbankingAccount", b =>
                {
                    b.Property<int>("MbankingAccountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MbankingAccountId"));
            ...
            modelBuilder.Entity("BankingEcosystem.Backend.Models.MbankingAccount", b =>
                {
                    b.HasOne("BankingEcosystem.Backend.Models.Card", "Card")
                        .WithMany()
